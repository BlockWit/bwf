...
import com.blockwit.bwf.service.rest.RolesRestService;
...
public class AdminRolesRestController {
	...
	@Autowired
	RolesRestService rolesRestService;

	@GetMapping(produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<PageDTO<RoleDTO>> items(
		...
		return ResponseEntity.ok(rolesRestService.findAll(page, pageSize));
	}
