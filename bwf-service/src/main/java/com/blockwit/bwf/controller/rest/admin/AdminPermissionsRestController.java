...
import com.blockwit.bwf.service.rest.PermissionsRestService;
...
public class AdminPermissionsRestController {
	...
	@Autowired
	PermissionsRestService permissionsRestService;

	@GetMapping(produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<PageDTO<PermissionDTO>> items(
		...
		return ResponseEntity.ok(permissionsRestService.findAll(page, pageSize));
	}
